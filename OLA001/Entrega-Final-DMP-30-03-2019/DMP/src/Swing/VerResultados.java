...
public class VerResultados extends javax.swing.JFrame {
    ...
    void mostarTabla() {
        ...
        try {
            ...
            csql.resultado = csql.consulta.executeQuery("SELECT fecha, enfermedad, nombreValor, valor, resultado FROM dmp.historial WHERE usuario LIKE '" + user + "' AND fecha LIKE '" + fechaHoy + "';");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ver Resultados");
        ...
        tablaResultado.setBackground(new java.awt.Color(153, 204, 255));
        tablaResultado.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel1.setText("Resultados De Hoy:");
